...
while(cap.isOpened()):
    ...
    def full_pipeline(image):
        ...
        # cv2.imshow('result_pipeline',result_pipeline)
        ...
        result = draw_lanes_image(image, result_pipeline, record_lane = record_lane)
        ...
        # car_from_middle = get_car_from_middle(record_lane)
        
        # font = cv2.FONT_HERSHEY_SIMPLEX
        # if (record_lane.radius_of_curvature is not None ):
        #     cv2.putText(result, "Left Radius: " + str(int(record_lane.radius_of_curvature)) + "m", 
